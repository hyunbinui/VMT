...
def run(args):
    ...
    for file in tqdm(os.listdir(args.video_dir)[5000:]):
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--video_dir', type=str, default='/data/VMT/video_data', help='directory that contains video clips')
    parser.add_argument('--video_dir', type=str, required=True, help='directory that contains video clips')
    parser.add_argument('--out_dir', type=str, default='/data/VMT/extracted_features/', help='directory for extracted action features')
